...
class Settings(BaseSettings):
    ...
    TRADING_PLAYBOOK_MARKET_DATA_MAX_CONCURRENCY: int = 8
    TRADING_PLAYBOOK_KLINE_STAGE_TIMEOUT_SECONDS: float = 55.0
    TRADING_PLAYBOOK_KLINE_CANCEL_GRACE_SECONDS: float = 0.25
    TRADING_PLAYBOOK_AUCTION_QUOTE_MAX_AGE_SECONDS: float = 120.0
    TRADING_PLAYBOOK_ALERT_QUOTE_MAX_AGE_SECONDS: float = 60.0
