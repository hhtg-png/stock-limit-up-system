...
const defaultColumns: ColumnConfig[] = [
  ...
  { prop: 'continuous_limit_up_days', label: '连板', width: 75, align: 'center', slot: true, sortable: 'custom' },
  { prop: 'first_limit_up_time', label: '首封时间', width: 95, sortable: 'custom' },
  ...
  { prop: 'seal_amount', label: '封单(万)', width: 95, align: 'right', slot: true, sortable: 'custom' },
