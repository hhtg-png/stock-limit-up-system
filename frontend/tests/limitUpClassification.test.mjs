...
assert.match(types, /primary_theme/, 'types should expose primary event theme')
assert.match(types, /fine_theme/, 'types should expose fine event theme')
assert.match(types, /secondary_themes/, 'types should expose secondary themes')
assert.match(types, /classification_evidence/, 'types should expose THS evidence sentence')
assert.match(types, /ths_move_analysis/, 'types should support THS original move analysis basis')
...
assert.match(types, /ths_article_url/, 'types should expose THS article URL')
assert.match(types, /ths_article_time/, 'types should expose THS article publish time')
...
assert.match(types, /board_label/, 'types should expose board display label')
...
assert.match(view, /证据句/, 'view should render THS evidence sentence')
assert.match(view, /classification_evidence/, 'view should render THS classification evidence')
assert.match(view, /ths_article_url/, 'view should link THS original analysis article')
assert.match(view, /ths_article_analysis/, 'view should show THS original analysis source status')
assert.match(view, /displayThemes/, 'view should render primary and secondary themes')
...
assert.match(view, /boardLabel/, 'view should render board display label')
